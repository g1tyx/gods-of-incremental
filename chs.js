...
var cnItems = {
    ...
    "Pure Energy Upgrade I": "纯能量升级 I",
    "Pure Energy Upgrade II": "纯能量升级II",
    "pure energy.": "纯粹能量。",
    ...
    "Next reset, you will energize with \"Stronger prestige energy.\"": "下次重置时，您将获得“更强的威望能量”。",
    "Next reset, you will energize with nothing.": "下次重置时，你将一无所有地充满活力。",
    "One of these advancements was to shorten meta-prestiges.": "这些进步之一是缩短元威望。",
    "Prestige Energy's good effect is multiplied by 8, but its downside is squared.": "威望能量的良好效果是乘以8，但它的缺点是平方。",
    "Prestige machines scale less (x3 -> x1.5), but machine corruptions are squared.": "威望机器的规模较小（x3 -> x1.5），但机器损坏是平方的。",
    "Pure Energy Upgrade III": "纯能量升级III",
    "Pure Energy Upgrade IV": "纯能量升级IV",
