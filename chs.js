...
var cnItems = {
    ...
    "Prestige points. The crudest form of prestige. Holds the entire tree together.": "声望点。 威望的最原始形式。 将整棵树固定在一起。",
    "Prestige Tree": "声望树",
    "Score Amplifier": "分数放大器",
    "The high god of the death realm seeks after this greatly.": "死亡领域的上位神非常追求这一点。",
    "The prestige tree: One of their creations. A creation of great power.": "威望树：他们的创作之一。 伟大力量的创造。",
    ...
    "": "",
    "Log X": "日志 X",
    "Pure Energy Upgrade V": "纯粹能量升级V",
    "Pure Energy Upgrade VI": "纯净能量升级VI",
    "Pure Energy Upgrade I": "纯粹能量升级 I",
    "Pure Energy Upgrade II": "纯粹能量升级II",
    "Pure Energy Upgrade III": "纯粹能量升级 III",
    "Pure Energy Upgrade IV": "纯粹能量升级 IV",
    "Log I": "日志 I",
    "Log II": "日志 II",
    "Log III": "日志 III",
    "Log IV": "日志 IV",
