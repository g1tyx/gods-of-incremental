...
var cnItems = {
    ...
    "Log XXVIII": "日志 XXVIII",
    "Log XXVIII: This may be the final entry. I am sorry I can not write more. I have been working on the tree 24/7 now. This may be the last time writing, but one day we will meet. I am sure of that. The prophet wants to meet you as well. It will happen one day. War is inevitable.": "日志 XXVIII：这可能是最后的条目。 很抱歉我不能写更多。 我现在 24/7 都在处理这棵树。 这可能是最后一次写信，但总有一天我们会见面的。 我确信这一点。 先知也想见见你。 有一天它会发生。 战争是不可避免的。",
    "This battery, which contains time, space and enhance powers within it. Truly encapsulates the prestige tree's third row. Once it powers up the pseudo-celestial, get ready, because the presence of a celestial caused your predecessor to vanish... also makes a good regular battery!": "这块电池，里面蕴藏着时间、空间和增强力量。 真正封装了威望树的第三行。 一旦它为伪天体供电，就做好准备，因为天体的存在导致你的前任消失......也可以制作一个很好的普通电池！",
    "": "",
    "": "",
    "": "",
    "": "",
