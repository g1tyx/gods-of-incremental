...
var cnItems = {
    ...
    "beacon power to produce incremental power": "信标功率产生增量功率",
    "But in times like these, it would be most efficient.": "但在这样的时期，这将是最有效的。",
    "ENHANCE": "提高",
    "Enhance Points": "增强点数",
    "Enhance Your Prestige Points": "提高你的声望点",
    "However, gaining incremental power with the beacon would be very slow.": "然而，通过信标获得增量功率将非常缓慢。",
