                   addLayer("i", {
                       ...
                       clickables: {
                           ...
                           43: {
                               ...
                               style: {
                                   background: 'linear-gradient(45deg, #b82fbd, purple)',
                                   width: '250px',
                                   minHeight: '125px',
                                   position: 'relative',
                                   overflow: 'hidden',
                           ...
                           stuff: {
                               ...
                               "Ce308, The Pseudo-Celestial of Pure Energy": {
                                   ...
                                   content:
                                       ...
                                       ["row", [
                                           ["raw-html", function() { return player.i.beatce308.eq(0) ? " <div class=spinning-symbol2>Θ</div>" : "" }],
                                           ["blank", "25px"],
                                           ["raw-html", function() { return player.ce308bosscutscene.eq(1) && player.ce308bossscene.gte(7) && player.ce308bossscene.lt(47) ? " <div class=spinning-symbol3>⚙</div>" : "" }]
                                       ]],
                               ...
                               "Chapter 1 Concluding Cutscene": {
                                   ...
                                   content:
                                       ...
                                       ["row", [
                                           ["raw-html", function() { return player.ce308defeatscene.gte(11) && player.ce308defeatscene.lt(18) ? " <div class=ce308symbol>Θ</div>" : "" }]
                                       ]],
                                       ["row", [
                                           ["raw-html", function() { return player.ce308defeatscene.eq(18) ? " <div class=ce308symbol2>Θ</div>" : "" }]
                                       ]],
                                       ["row", [
                                           ["raw-html", function() { return player.ce308defeatscene.eq(19) ? " <div class=ce308symbol3>Θ</div>" : "" }]
                                       ]],
                                       ["row", [
                                           ["raw-html", function() { return player.ce308defeatscene.eq(20) ? " <div class=ce308symbol4>Θ</div>" : "" }]
                                       ]],
                           ...
                           pureenergy: {
                               ...
                               "Superifier": {
                                   ...
                                   content: [
                                       ...
                                       ["row", [
                                           ["raw-html", function() { return player.superifiercutscene.eq(0) ? "<h3>" + format(player.points) + " points" + " -> " + format(player.i.superpointstoget) + " super points" : "" }, { "color": "white", "font-size": "18px", "font-family": "monospace" }],
                                           ["blank", "25px"],
                                           ["clickable", 46]
                                       ]],
                                       ["blank", "25px"],
                                       ...
                                       ["row", [
                                           ["raw-html", function() { return player.superifiercutscene.eq(0) && hasUpgrade("i", 25) ? "<h3>" + format(player.i.prestigeenergy) + " prestige energy" + " -> " + format(player.i.superprestigeenergytoget) + " super prestige energy" : "" }, { "color": "#ffffaa", "font-size": "18px", "font-family": "monospace" }],
                                           ["blank", "25px"],
                                           ["clickable", 47]
                                       ]],
                                       ["blank", "25px"],
                                       ...
                                       ["row", [
                                           ["raw-html", function() { return player.superifiercutscene.eq(0) && hasUpgrade("i", 26) ? "<h3>" + format(player.i.pureenergy) + " pure energy" + " -> " + format(player.i.superpureenergytoget) + " super pure energy" : "" }, { "color": "#ffffaa", "font-size": "18px", "font-family": "monospace" }],
                                           ["blank", "25px"],
                                           ["clickable", 48]
                                       ]],
                                       ["row", [
                                           ["raw-html", function() { return player.superifiercutscene.eq(0) && hasUpgrade("i", 26) ? "<h5>(Resets pure energy amount)" : "" }, { "color": "#ffffaa", "font-size": "18px", "font-family": "monospace" }],
                                           ["blank", "25px"]
                                       ]],
                                       ["blank", "25px"],
                                       ["row", [
